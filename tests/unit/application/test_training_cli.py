...
from taac2026.infrastructure.pcvr.train_stack import PCVRTrainDataBundle, build_pcvr_train_hooks
...
def test_parse_train_args_forwards_experiment_specific_options() -> None:
    ...
    assert args.experiment == "experiments/pcvr/baseline"
...
def test_parse_train_args_allows_missing_dataset_path() -> None:
    args, extra = parse_train_args(["--experiment", "experiments/maintenance/host_device_info"])

    assert args.experiment == "experiments/maintenance/host_device_info"
