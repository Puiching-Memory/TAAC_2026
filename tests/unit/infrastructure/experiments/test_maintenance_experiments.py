...
def _load_package_module(package_name: str):
    package_dir = REPO_ROOT / "experiments" / "maintenance" / package_name
...
def _load_host_device_info_runner_module():
    package_dir = REPO_ROOT / "experiments" / "maintenance" / "host_device_info"
...
@pytest.mark.parametrize(
    ...
    [("experiments/maintenance/host_device_info", False), ("experiments/maintenance/online_dataset_eda", True)],
)
