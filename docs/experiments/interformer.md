...
```bash
uv run taac-train \
  --experiment experiments/pcvr/interformer \
...
- 模型源码：`experiments/pcvr/interformer/model.py`
- NS Groups：`experiments/pcvr/interformer/__init__.py` 中的 `USER_NS_GROUPS` / `ITEM_NS_GROUPS`
