...
```bash
uv run taac-train \
  --experiment experiments/pcvr/onetrans \
...
- 模型源码：`experiments/pcvr/onetrans/model.py`
- NS Groups：`experiments/pcvr/onetrans/__init__.py` 中的 `USER_NS_GROUPS` / `ITEM_NS_GROUPS`
