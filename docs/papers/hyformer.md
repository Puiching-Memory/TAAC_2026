...
$$
P(y = 1 \mid S, u, v) \in \lbrack 0,1 \rbrack,
$$
...
$$
Q = \lbrack \widetilde{Q}_{(l)}, F_1, \ldots, F_M \rbrack \in \mathbb{R}^{T \times D},
$$
...
$$
q_t = \lbrack\, q_t^{(1)} \| q_t^{(2)} \| \cdots \| q_t^{(T)} \,\rbrack,
...
$$
\hat{Q} = \lbrack \widetilde{q}_1, \widetilde{q}_2, \ldots, \widetilde{q}_T \rbrack \in \mathbb{R}^{T \times D}.
$$
