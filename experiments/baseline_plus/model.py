...
class PCVRBaselinePlus(nn.Module):
    """PCVRBaselinePlus model for post-click conversion rate prediction.
    ...
    def forward(self, inputs: ModelInput) -> torch.Tensor:
        """Runs the forward pass of the PCVRBaselinePlus model."""
